...
export default function Home() {
  const categories = [
    { name: "YouTube", icon: Youtube, path: "/youtube", color: "bg-red-600", desc: "Download Video & MP3" },
    { name: "TikTok", icon: Video, path: "/tiktok", color: "bg-pink-600", desc: "No Watermark Video" },
